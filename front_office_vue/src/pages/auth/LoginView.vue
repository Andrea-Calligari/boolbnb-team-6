   ...
   <div class="container ms_container d-flex flex-column justify-content-center align-items-center">
         ...
         <form @submit.prevent="onLogin" class="form_main">
            ...
            <div class="inputContainer">
               ...
               <input type="email" class="inputField" id="email" aria-describedby="emailHelp" placeholder="Email" required v-model="email">
            </div>
            ...
            <div class="inputContainer">
               ...
               <input type="password" class="inputField" id="password" required v-model="password" placeholder="Password">
            </div>
