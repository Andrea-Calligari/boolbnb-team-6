                    ...
                    <div class="title-price-section">
                        ...
                        <div class="price-section ">
                            ...
                            <form @submit.prevent="onSend" v-if="apartment.user_id !== store.user.id" class="
                                ...
                                <div class="m-2  text-center text-success fs-3" v-if="send === true">Messaggio Inviato!
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                    ...
                    <div class="offcanvas-body">
                        <form @submit.prevent="onSend">
                            ...
                            <div class="mb-4 text-center text-success fs-3" v-if="send === true">Messaggio inviato con
                                successo!</div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Elimina annuncio</h1>
